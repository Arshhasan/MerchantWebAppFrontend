          ...
          <div className="auth-logo-section">
            <div className="logo-icon">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 2C8 2 4.5 4.5 4.5 8.5C4.5 12.5 8 15 12 15C16 15 19.5 12.5 19.5 8.5C19.5 4.5 16 2 12 2Z" fill="#2E7D32"/>
                <path d="M8 18C6 18 4.5 19.5 4.5 21.5C4.5 23.5 6 25 8 25C10 25 11.5 23.5 11.5 21.5C11.5 19.5 10 18 8 18Z" fill="#2E7D32"/>
                <path d="M16 18C14 18 12.5 19.5 12.5 21.5C12.5 23.5 14 25 16 25C18 25 19.5 23.5 19.5 21.5C19.5 19.5 18 18 16 18Z" fill="#2E7D32"/>
              </svg>
            </div>
